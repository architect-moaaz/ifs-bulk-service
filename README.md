...
3. The status API:
    ...
    1. Will fetch all the uploaded file with the status
       {URL}/upload-file/getAllUploadsStatus
    2. Will fetch the particular uploads' status
...
3.   The status API:
     1. Will fetch all the records status
         {URL}/upload-file/getAllUploadsStatus
          Type: GET
          Request body : {}
          Response : [
...
3. Api to get the error log of the file uploaded:
